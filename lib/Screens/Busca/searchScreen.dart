      ...
      body: ListView(
        children: [
          Padding(
            ...
            child: Text('Categorias', style: textBoldNunito(16)),
          ),
          Wrap(
            children: [
              ...
              card(185, 80, Color.fromARGB(255, 1, 100, 4), 'Pet', 'assets/pet.png'),
              card(185, 80, Colors.deepPurple, 'Açaí', 'assets/acai.png'),
              ...
              card(187, 80, Colors.orange, 'Espetinho', 'assets/carnes.png'),
              card(185, 80, Colors.orange, 'Hot Dog', 'assets/hotDog.png'),
              card(185, 80, Color.fromARGB(255, 255, 214, 152), 'Marmita', 'assets/marmita.png'),
              card(185, 80, Colors.green, 'Suco', 'assets/sucos.png'),
              card(185, 80, Colors.orange, 'Sopas', 'assets/sopas.png'),
              card(185, 80, Colors.orange, 'Peixes', 'assets/peixes.png'),
